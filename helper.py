...
# def volume_aggregator(
#     extracted_csv_name: str = "volume/extracted_data.csv", slice_data: dict = None
# ):
#     # Find the start time
#     start_time = time.time()

#     df = pd.read_csv(extracted_csv_name, index_col=0)
...
#                 print(
#                     f"Cut at {os.environ['DIR1']} position: {x_coords[i]}, "
#                     f"from {os.environ['DIR2']}: {start_cut_position} to {end_cut_position} # 10% offset"
#                 )
#                 print(f"Accumulated volume: {total_volume/1000:.2f} cm^3")
#                 total_volume = 0.0  # Reset for the next slice
...
#     else:
#         print(
#             f"The volume of the scanned object is approximately {total_volume/1000:.2f} cm^3."
